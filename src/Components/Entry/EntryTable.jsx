      ...
      <table className=" table-auto border-collapse text-sm">
        <thead className="bg-gray-50 text-gray-700 font-medium">
          <tr>
            ...
            <Th label="Motivo" sortKey="notes" requestSort={requestSort} getArrow={getArrow} />
            <Th label="Odómetro" sortKey="mileage" requestSort={requestSort} getArrow={getArrow} extraClasses="hidden md:table-cell" />
            <Th label="Comb." extraClasses="hidden lg:table-cell" />
            <Th label="Aceite" extraClasses="hidden xl:table-cell" />
            <Th label="Mecánica" extraClasses="hidden xl:table-cell" />
            <Th label="Neumáticos" extraClasses="hidden xl:table-cell" />
            <Th label="Interiores" extraClasses="hidden xl:table-cell" />
            <Th label="Repuesto" extraClasses="hidden xl:table-cell" />
            <Th label="USB" extraClasses="hidden xl:table-cell" />
            <Th label="Soporte Tel." extraClasses="hidden xl:table-cell" />
            <Th label="Kit Emerg." extraClasses="hidden xl:table-cell" />
          </tr>
        </thead>
          ...
          {sortedEntries.map((entry) => (
            ...
            >
              ...
              <td className="px-4 py-3 hidden lg:table-cell">
                <FuelBar value={entry.fuelLevel} />
              </td>

              <td className="px-4 py-3 hidden xl:table-cell">{entry.oilLevel}</td>
              <td className="px-4 py-3 hidden xl:table-cell">{entry.mecanicState}</td>
              <td className="px-4 py-3 hidden xl:table-cell">{entry.tiresState}</td>
              <td className="px-4 py-3 hidden xl:table-cell">{entry.interiorsState}</td>
              <td className="px-4 py-3 hidden xl:table-cell"><YesNo value={entry.hasSpareTire} /></td>
              <td className="px-4 py-3 hidden xl:table-cell"><YesNo value={entry.hasChargerUSB} /></td>
              <td className="px-4 py-3 hidden xl:table-cell"><YesNo value={entry.hasPhoneSupport} /></td>
              <td className="px-4 py-3 hidden xl:table-cell"><YesNo value={entry.hasEmergencyKit} /></td>
            </tr>
          ))}
